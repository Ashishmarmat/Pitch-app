...
const UserOpenShareMoment = props => {
  ...
  useEffect(() => {
    console.log('pppp', props.navigation.state.params.shareItem);
  ...
  const sharedMomentsComment = () => {
    toggleModal();
    NavigationService.navigate('EditPostScreen', { shareItem: shareItemData });
  };
  const goBackFunc = () => {
...
const mapStateToProps = state => {
  console.log('UserOpenShareMoment state', state);
  return {
...
export default connect(mapStateToProps, {})(UserOpenShareMoment);
