...
const HomeProfileScreenNew = ({ navigation, ...props }) => {
  ...
  // console.log("sharedMomentData", sharedMomentData)
  ...
  useEffect(() => {
    if (props != undefined) {
      ...
      if (
        ...
        // console.log('graphData', props.profileRes.data.graph[0])
      }
    }
  }, [props]);

  // console.log("showBadgeEditBtn", showBadgeEditBtn)
  ...
  const likeWorkWithFunc = () => {
    ...
    // console.log("likeWorkWithFunc sendData", sendData)
    dispatch(likeWorkWithMe(sendData));
  };

  const goToChoosenCard = () => {
    // console.log("goToChoosenCard", workWithMeSelected)
        ...
        {getProfileData != undefined && (
          <View style={styles.headerMainView}>
            {getProfileData.user_cover_img ===
              ...
              //     <Image source={Images.ProfileRectangle} style={styles.rectangleImg} />
              // ) : (
              //     <Image source={{ uri: getProfileData.user_cover_img }} style={styles.rectangleImg} />
              // )}
              <ImageBackground
          ...
          <View style={styles.profileMainView}>
            ...
            <View style={styles.profileNameMainView}>
              ...
              {getProfileData.connectioncount[0] != undefined &&
                ...
                undefined && (
                  <View
                  // onPress={() => NavigationService.navigate('ConnectionList', { user_id: getEndUserProfile.user_id })}
                  >
                    <Text
        ...
        <View style={{ marginTop: scale(140) }}>
          ...
          {aboutTab ? (
            <View>
              <View style={styles.profileStrengthView}>
                ...
                <View
                  ...
                  {/* {skillStatus == '1' ? (
                                        <View >
                                            <View style={{ flexDirection: 'row' }}>
                                                <View style={{ height: 30, width: 30, borderRadius: 50, borderWidth: 1, borderColor: "#828282", justifyContent: 'center', backgroundColor: '#4A20E4' }}>
                                                    <Text style={{ fontSize: 10, color: "#fff", alignSelf: 'center' }}>1</Text>
                                                </View>
                                                <View style={{ height: 2.5, width: 46, borderWidth: 1, borderColor: "#4A20E4",backgroundColor:'#4A20E4',alignSelf: 'center' }}>
                                                </View>
                                            </View>
                                            <View style={{ marginTop: 6 }}>
                                                <Text style={{ fontSize: 8.5, lineHeight: 10, color: "#828282", width: 62, textAlign: 'center', right: 15 }}>Add your skills</Text>
                                            </View>
                                        </View>
                                    ) : */}
                  <View>
                  ...
                  {/* }
                                    {AnswerAboutYourStatus == '1' ? (
                                        <View >
                                            <View style={{ flexDirection: 'row' }}>
                                                <View style={{ height: 30, width: 30, borderRadius: 50, borderWidth: 1, borderColor: "#828282", justifyContent: 'center', backgroundColor: '#4A20E4' }}>
                                                    <Text style={{ fontSize: 10, color: "#fff", alignSelf: 'center' }}>2</Text>
                                                </View>
                                                <View style={{ height: 2.5, width: 46, borderWidth: 1, borderColor: "#4A20E4",backgroundColor:'#4A20E4', alignSelf: 'center' }}>
                                                </View>
                                            </View>
                                            <View style={{ marginTop: 6 }}>
                                                <Text style={{ fontSize: 8.5, lineHeight: 10, color: "#828282", width: 62, textAlign: 'center', right: 15 }}>Answer some questions about your</Text>
                                            </View>
                                        </View>
                                    ) : */}
                  <View>
                  ...
                  {/* }
                                    {ShareMomentStatus == '1' ? (
                                        <View >
                                            <View style={{ flexDirection: 'row' }}>
                                                <View style={{ height: 30, width: 30, borderRadius: 50, borderWidth: 1, borderColor: "#828282", justifyContent: 'center', backgroundColor: '#4A20E4' }}>
                                                    <Text style={{ fontSize: 10, color: "#fff", alignSelf: 'center' }}>3</Text>
                                                </View>
                                                <View style={{ height: 2.5, width: 46, borderWidth: 1, borderColor: "#4A20E4",backgroundColor:'#4A20E4', alignSelf: 'center' }}>
                                                </View>
                                            </View>
                                            <View style={{ marginTop: 6 }}>
                                                <Text style={{ fontSize: 8.5, lineHeight: 10, color: "#828282", width: 62, textAlign: 'center', right: 15 }}>Share some memories</Text>
                                            </View>
                                        </View>
                                    ) : */}
                  <View>
                  ...
                  {/* }
                                    {WorkExpStatus == '1' ? (
                                        <View >
                                            <View style={{ flexDirection: 'row' }}>
                                                <View style={{ height: 30, width: 30, borderRadius: 50, borderWidth: 1, borderColor: "#828282", justifyContent: 'center', backgroundColor: '#4A20E4' }}>
                                                    <Text style={{ fontSize: 10, color: "#fff", alignSelf: 'center' }}>4</Text>
                                                </View>
                                                <View style={{ height: 2.5, width: 46, borderWidth: 1, borderColor: "#4A20E4",backgroundColor:'#4A20E4', alignSelf: 'center' }}>
                                                </View>
                                            </View>
                                            <View style={{ marginTop: 6 }}>
                                                <Text style={{ fontSize: 8.5, lineHeight: 10, color: "#828282", width: 62, textAlign: 'center', right: 15 }}>Add your work experiences</Text>
                                            </View>
                                        </View>
                                    ) : */}
                  <View>
                  ...
                  {/* }
                                    {FrndReqStatus == '1' ? (
                                        <View >
                                            <View style={{ flexDirection: 'row' }}>
                                                <View style={{ height: 30, width: 30, borderRadius: 50, borderWidth: 1, borderColor: "#828282", justifyContent: 'center', backgroundColor: '#4A20E4' }}>
                                                    <Text style={{ fontSize: 10, color: "#fff", alignSelf: 'center' }}>5</Text>
                                                </View>
                                            </View>
                                            <View style={{ marginTop: 6 }}>
                                                <Text style={{ fontSize: 8.5, lineHeight: 10, color: "#828282", width: 62, textAlign: 'center', right: 15 }}>Pitch a friend request</Text>
                                            </View>
                                        </View>
                                    ) : */}
                  <View>
              ...
              <View style={styles.badgesMainView}>
                ...
                {/* <TouchableOpacity style={[styles.addImageTouchStyle, { marginLeft: -15 }]}>
                                    <Image source={require('../../../assets/images/Group1726.png')} style={styles.addImageStyle} />
                                </TouchableOpacity> */}
              </View>
                      ...
                      <TouchableOpacity
                        ...
                        <View>
                          {sendDataVal.imagetype === 1 ? (
                            ...
                            // <Image source={{ uri: bigImage }} style={styles.shareMomBigImage} />
                            <View>
                              {isLoading ? (
                                <ActivityIndicator
                                  animating
                          ...
                          <TouchableOpacity
                            ...
                            <View>
                              {shareItem.imagetype === 1 ? (
                                ...
                                // <View style={{ position: 'absolute', left: '35%', right: 0, top: '28%', }}>
          ...
          {experienceTab ? (
            <View style={{ marginTop: scale(30) }}>
                        ...
                        {teamListArray.map((teamItem, teamIndex) => (
                          <TouchableOpacity
                            ...
                            {teamItem != undefined &&
                              ...
                              // <Image source={{ uri: teamItem.profile_file }}
                              <View>
              ...
              <View style={{ paddingHorizontal: 20, marginTop: scale(15) }}>
                <View
                  style={{
                    flexDirection: 'row',
                    justifyContent: 'space-between',
                                ...
                                {labeltem.status && (
                                  <View>
                                    <View
                                      ...
                                      {/* <TouchableOpacity>
                                                                                    <Text style={{ color: '#864AFF', fontSize: 12, fontWeight: 'normal', marginTop: 8 }}>...see more</Text>
                                                                                </TouchableOpacity> */}
                                      ...
                                      <ScrollView
                                        ...
                                        {/* {labeltem.teammmembers != null && labeltem.teammmembers != "" && 
                                                                                    <Text>aefsskjhgjhkjghj</Text>
                                                                                    } */}
...
export default connect(mapStateToProps, {})(HomeProfileScreenNew);
