...
const EditTeamScreen = props => {
  ...
  //             const results = b.filter(({ id: id1 }) => !a.some(({ id: id2 }) => id2 === id1));
  ...
  // console.log("suggestionListArray", suggestionListArray)
  ...
  const goToNewTeam = () => {
    dispatch(postTeamSuggestionSuccess());
    NavigationService.navigate('AddNewTeam');
  };
                    ...
                    isModalVisible ? (
                        ...
                        >
                            <KeyboardAvoidingView keyboardVerticalOffset={200}
                                ...
                                <View>
                                    <Text style={{ marginTop: '15%', alignSelf: 'center' }}>Team Member Name</Text>
                                </View>
                                <View style={{
                                    width: '100%', borderRadius: 10, marginTop: scale(25),
                                }}>
                                    <ScrollView>
                                        <CustomTextInput
                                            style={{ width: '95%', backgroundColor: 'rgba(242, 242, 242, 0.7)', height: scale(40), paddingHorizontal: 8, alignSelf: 'center' }}
                                                    ...
                                                    <View>
                                                        {
                                                            suggestionListArray.map((teamItem, teamIndex) => (
                                                                <TouchableOpacity onPress={() => pushedSelected(teamItem)} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingHorizontal: 10, marginTop: 10 }}>
                                                                    <Text>{teamItem.full_name}</Text>
                                                                    <Image source={teamItem.isSelected ? require('../../../assets/images/ic_checked.png') : require('../../../assets/images/rectangle.png')} style={{ height: 20, width: 20, resizeMode: 'contain' }} />
                                                                </TouchableOpacity>
                                                            ))}
                                                    </View>) : null
                                        ...
                                        {
                                            suggestionRes != undefined && suggestionRes != '' && suggestionListArray.length === 0 ?
                                        ...
                                        <TouchableOpacity
                                            ...
                                            style={{
                                                height: scale(40),
                                                width: width / 3 + 50,
                                                backgroundColor: apiSendData != undefined ? '#4A20E4' : 'lightgrey',
                                                borderRadius: 5,
                                                alignSelf: 'center',
                                                marginTop: scale(30),
                                                alignItems: 'center',
                                            ...
                                            <Text style={{ color: '#fff', fontSize: 12, fontWeight: '600' }}>Add Member</Text>
                                        </TouchableOpacity>
                                        <TouchableOpacity style={{ alignSelf: 'center', marginTop: scale(10) }}>
                                            <Text onPress={() => toggleModal()} style={{ textDecorationLine: 'underline', color: '#8D8D8D', fontSize: 12 }}>Cancel</Text>
                                        </TouchableOpacity>
                                    </ScrollView>
                                </View>
                                ...
                                <TouchableOpacity
                                    ...
                                    <Text style={{ textDecorationLine: 'underline', color: '#8D8D8D', fontSize: 12 }}>Can't find who you're looking for? Invite Now</Text>
                                </TouchableOpacity>
                            </KeyboardAvoidingView>
                        </Modal>) : null} */}
