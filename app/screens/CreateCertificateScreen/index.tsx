...
const CreateCertificateScreen = props => {
  const dispatch = useDispatch();
  const AddCertificateRes = useSelector(
    state => state.CertificateListReducer.addCertificateData,
  );
  ...
  useEffect(() => {
    if (
      AddCertificateRes &&
      AddCertificateRes != undefined &&
      AddCertificateRes.response_code &&
      AddCertificateRes.response_code === 200
    ) {
  ...
  const goToNext = () => {
    dispatch(addUserCertificateSuccess());
    ...
    return (
      <View style={styles.headerMainView}>
        ...
        <View style={styles.titleMainView}>
          <Text style={styles.titleTextStyle}>Add Certificate</Text>
        </View>
        <TouchableOpacity
          onPress={() => addCertificatefunc()}
  ...
  const addCertificatefunc = () => {
    ...
    if (startDate > endDate) {
      ...
      dispatch(AddUserCertificateApi(sendData));
    }
  };
...
export default connect(mapStateToProps, {})(CreateCertificateScreen);
