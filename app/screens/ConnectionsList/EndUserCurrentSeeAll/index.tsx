...
const EndUserCurrentSeeAll = props => {
  ...
  const goToEndUser = async listItem => {
    // console.log("listItem", listItem.receiver_id)
      ...
      <ScrollView>
          ...
          <View
            ...
            {totalCount != undefined && (
              <Text
                ...
                {connectionArray.length} Current Connections
              </Text>
            )}
            <Text
              style={{
        ...
        <View>
          ...
          {connectionArray && connectionArray.length > 0 ? (
            <View>
              {connectionArray.map((mutualItem, mutualIndex) => (
...
const mapStateToProps = state => {
  // console.log("EndUserCurrentSeeAll state",state)
  return {};
};

export default connect(mapStateToProps, {})(EndUserCurrentSeeAll);
